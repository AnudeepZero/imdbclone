...
export default async function MoviePage({params}) {
  // this params coming from Card.jsx Link href
  ...
  return (
    <div className='w-full' >
      ...
      <Image src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.poster_path}`}  width={500} height={300} alt={movie.title}
        className='rounded-lg' placeholder='blur' blurDataURL='/spinner.svg'
        style={{
            maxWidth: "100%",
            height: "100%",
        }} 
